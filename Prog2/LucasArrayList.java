...
/**
 * 
 * @author Jonathan Christian Sanchez
 *
 */
...
public class LucasArrayList<E> {
    ...
    private void reallocate() {
        ...
        /** create array with twice the memory as the previous array */
    ...
    private class CurrentPosition implements ListIterator<E> {
    	...
    	private boolean ResultingIndex(int index) {
		...
		public boolean hasNext() {
			...
			return ResultingIndex(nextIndex());
		}
		...
		public boolean hasPrevious() {
			...
			return ResultingIndex(previousIndex());
		}
